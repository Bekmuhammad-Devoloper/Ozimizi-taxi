...
// Profile and Balans both live inside the Profile screen now (header
// icon for Profile, in-page link for Balans), so the bottom nav stays
// focused on the two flows a driver hits while working.
const items = [
